...
import analyzer.singleton.SingletonAnalyzer;
import analyzer.utility.ISystemModel;
import config.Configuration;
import demos.EagerChocolateBoiler;
import demos.LazyChocolateBoiler;
...
//        config.add(EngineConfiguration.ANALYZER_KEY, ClassParserAnalyzer.class.getName(), FavorCompositionAnalyzer.class.getName(), RelationParserAnalyzer.class.getName());
//        config.add(ModelConfiguration.CLASSES_KEY, FavorDummyA.class.getName(), FavorDummyB.class.getName());
        config.add(EngineConfiguration.ANALYZER_KEY, RelationParserAnalyzer.class.getName(), DecoratorAnalyzer.class.getName(), ClassParserAnalyzer.class.getName());
...
//        config.add(ModelConfiguration.CLASSES_KEY, EagerChocolateBoiler.class.getName(), LazyChocolateBoiler.class.getName());
