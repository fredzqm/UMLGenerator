...
//        config.add(ModelConfiguration.CLASSES_KEY, FavorDummyA.class.getName(), FavorDummyB.class.getName());
        config.add(EngineConfiguration.ANALYZER_KEY, ClassParserAnalyzer.class.getName(), RelationParserAnalyzer.class.getName(), SingletonAnalyzer.class.getName());
//        config.add(ModelConfiguration.CLASSES_KEY, Component.class.getName(), Decorator.class.getName(), Decorator.class.getName());
