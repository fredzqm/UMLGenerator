...
public interface IConfiguration {
    ...
    /**
     * @param directory the directory to add this map
     ...
     *
     * @param configClass the class we want to create
     * @param returnType  the planned return type, if returnType and configClass are the
