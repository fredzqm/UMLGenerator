...
public class GraphVizClassElementParserFactory implements IClassElementParserFactory {
	...
	GraphVizClassElementParserFactory() {
		// TODO: Figure out what else might change with this factory. At the
		// moment, we have separated the creation (what changes) from the
		// formatting (what stays the same).
	}
